...
const Hero = () => {
  return (
    <section className='mt-5 relative w-full h-[800px] mx-auto'>
      <div className={`${styles.paddingX} md:mt-[130px] absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>• Develop full stack applications.</p>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>• Improve organisational efficiency.</p>
